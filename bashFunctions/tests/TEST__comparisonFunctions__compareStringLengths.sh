...
string1List[${#string1List[@]}]='longer'
string2List[${#string2List[@]}]='long'
expectedOutputList[${#expectedOutputList[@]}]=1

string1List[${#string1List[@]}]='long'
string2List[${#string2List[@]}]='longer'
expectedOutputList[${#expectedOutputList[@]}]=-1
...
string1List[${#string1List[@]}]='ABCDEFG'
string2List[${#string2List[@]}]='ZYX'
expectedOutputList[${#expectedOutputList[@]}]=1
...
do
    ...
    actualOutput="$(compareStringLengths "${string1}" "${string2}")"
